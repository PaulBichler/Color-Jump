...
class CollisionHandler
{
	...
	static bool Collide(Character& character, const PlatformPart& platform_part, Platform* platform);
...
public:
	...
	static void GetGroundRayCasts(std::map<Character*, std::set<SceneNode::Pair>>& sets, const SceneNode::Pair& pair, const Category
	                              ::Type category);
