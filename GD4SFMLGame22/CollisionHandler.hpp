...
class CollisionHandler
{
	...
	static void StopPlayerMovement(Character& player, const PlatformPart& platform_part,
	                               Platform* platform);
	static bool CollideFromAbove(Character& player, const PlatformPart& platform_part,
	                             Platform* platform);
...
public:
	...
	static void GetGroundRayCasts(std::map<Character*, std::set<SceneNode::Pair>> sets, const SceneNode::Pair& pair, const
	                              Category::Type category);
